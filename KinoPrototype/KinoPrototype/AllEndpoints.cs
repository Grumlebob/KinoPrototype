                    ...
                    e => new JoinEvent
                    {
                        ...
                        Showtimes = e.Showtimes.Select(s => new Showtime
                        {
                            ...
                            Movie = new Movie()
                            {
                                ...
                                Title = s.Movie.Title, ImageUrl = s.Movie.ImageUrl, Duration = s.Movie.Duration, KinoURL = s.Movie.KinoURL, IsSpecialShow = s.Movie.IsSpecialShow
                            },
                ...
                foreach (var movieId in movieIds)
                {
                    ...
                    if (existingMovie == null)
                    {
                        ...
                        context.Movies.Add(new Movie
                        {
                            ...
                            IsSpecialShow = movie.IsSpecialShow
